              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ اهلا بكم يا اصدقاء فينو FF بوت ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡البوت مدعوم من:[FF0000] فينو FF 
[FFFFFF]🎯 الحاله: [00FF00] ناشط 24/7
[FFFFFF]📱 للتواصل: [FFFF00]@FENOTOP1
[00FF00]»»————-　★　————-««
[FF0000]█▓▒░░ استمتع بالبوت! ░░▒▓█"""
                ...
                if senthi == True:
                    ...
                    def get_random_color(): return "_" 
                    message = """[B][C][FF0000]█▓▒░░ اهلا بكم يا اصدقاء FLASH FF BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ البوت مدعوم من:[FF0000] فينو FF
[FFFFFF]🎯 الحاله: [00FF00]ناشط 24/7
[FFFFFF]📱 للتواصل: [FFFF00]@FENOTOP1
                        ...
                        if inPuTMsG.strip().startswith('/praisa'):
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    messages = [
                                        "🌟 {Name} ارحب الغالي وصال نورت الفريق ",
                                        "🔥 {Name} ارحب الغالي وصال نورت الفريق",
                                        "💎 {Name} ارحب الغالي وصال نورت الفريق",
                                        "🚀 {Name} ارحب الغالي وصال نورت الفريق",
                                        "👑 {Name} ارحب الغالي وصال نورت الفريق",
                                        ...
                                        "💫 {Name} ارحب الغالي وصال نورت الفريق",
                                        "🌍 {Name} ارحب الغالي وصال نورت الفريق",
                                        "🛡️ {Name} ارحب الغالي وصال نورت الفريق",
                                        "🏅 {Name} ارحب الغالي وصال نورت الفريق"
                                    ]
...
│  └─ [FF0000]/help
├─ [FFFFFF]فريق من 3 لاعبين
│  └─ [FF0000]/3
├─ [FFFFFF]فريق من 5 لاعبين
│  └─ [FF0000]/5
├─ [FFFFFF]فريق من 6 لاعبن
│  └─ [FF0000]/6
├─ [FFFFFF]انضم إلى البوت في الفريق
│  └─ [FF0000]/join [team_code]
├─ [FFFFFF]مغادرة فريق البوت
│  └─ [FF0000]/exit
├─ [FFFFFF]طرد لاعب من الفريق
│  └─ [FF0000]/kick [uid]
└─ [FFFFFF]بدء المباراة
   └─ [FF0000]/start 
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
...
├─ [FFFFFF]إرسال إعجابات إلى الحساب⚡
│  └─ [FF0000]/like [uid]
├─ [FFFFFF]معلومات اللاعب 
│  └─ [FF0000]/info [uid]
├─ [FFFFFF]الحصول على معلومات اللاعب
│  └─ [FF0000]/bio [uid]
├─ [FFFFFF]معلومات مستوى الحساب
│  └─ [FF0000]/level [uid]
├─ [FFFFFF]TikTok Id Info
│  └─ [FF0000]/tt [username]
├─ [FFFFFF]YouTube Channel Info
│  └─ [FF0000]/yt [name]
├─ [FFFFFF]معلومات النقابه 
│  └─ [FF0000]/guild [guild_id]
└─ [FFFFFF]الحصول على حالة اللاعب 
   └─ [FF0000]/status [uid]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
...
├─ [FFFFFF]الدردشة مع الذكاء الاصطناعي
│  └─ [FF0000]/ai [question]
├─ [FFFFFF]التحقق من حظر الحساب 
│  └─ [FF0000]/check [uid]
├─ [FFFFFF]إضافة بوت إلى قائمة الأصدقاء 
│  └─ [FF0000]/add [uid]
├─ [FFFFFF]إزالة من قائمة الأصدقاء 
│  └─ [FF0000]/remove [uid]
├─ [FFFFFF]صديق جالي 
│  └─ [FF0000]/gali [name]
├─ [FFFFFF]رسالة مباشرة 
...
├─ [FFFFFF]مهاجمة الفريق 
│  └─ [FF0000]/attack [Team Code]
├─ [FFFFFF]بوت رفع المستوى
│  └─ [FF0000]/lw [Team Code]
├─ [FFFFFF]إيقاف بوت رفع المستوى 
│  └─ [FF0000]/stop
...
├─ [FFFFFF]سبام شاره  'Old V'
│  └─ [FF0000]/s4 [uid]
├─ [FFFFFF]سبام شاره  'Pro'
│  └─ [FF0000]/s5 [uid]
├─ [FFFFFF]بوت سريع ⚡⚡⚡
│  └─ [FF0000]/speed
├─ [FFFFFF]رقصات اسلاحه مطوره بدون توقف
│  └─ [FF0000]@evos
├─ [FFFFFF]رقصات اسلحه مطوره بل iD
│  └─ [FF0000]@evos [uid]
├─ [FFFFFF]ايقاف رقصات اسلحه مطوره 
│  └─ [FF0000]@sevos
├─ [FFFFFF]رقصات لك بدون iD 
│  └─ [FF0000]/e [من 1 إلي 410]
└─ [FFFFFF]رقصات لصديقك بل iD
   └─ [FF0000]/e [uid] [من 1 إلي 410]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            await safe_send_message(response.Data.chat_type, menu6, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu7 = """[C][B][FFD700]═══⚡COMMAND MENU 47-54⚡═══[FFFFFF][B]
├─ [FFFFFFتشغيل رقصه بدون بوت
│  └─ [FF0000]/me [Team Code] [emote]
├─ [FFFFFF]تشغيل رقصه صديقك بدون بوت
│  └─ [FF0000]/me [tc] [uid] [emote]
├─ [FFFFFF]رقصات اسلحه مطوره iD 
│  └─ [FF0000]/evo [uid] [1-21]
├─ [FFFFFF]رقصه سريعه 25x
│  └─ [FF0000]/fast [uid] [emote id]
├─ [FFFFFF]OFF/كتم الصوت (المشرف)
│  └─ [FF0000]/off
├─ [FFFFFF]ON/إلغاء كتم الصوت (المشرف)
│  └─ [FF0000]/unmute 
├─ [FFFFFF]حظر المستخدم (المشرف)
│  └─ [FF0000]/block [uid]
└─ [FFFFFF]إلغاء حظر المستخدم (المشرف)
   └─ [FF0000]/unblock [uid]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
...
├─ [FFFFFF]رسالة ترحيب للاعب 
│  └─ [FF0000]/praisa [name]
├─ [FFFFFF]إرسال إعجابات وهمية⚡
│  └─ [FF0000]/fake_like [uid]
├─ [FFFFFF]معرف العنصر للمعلومات
│  └─ [FF0000]/item [item_id]
├─ [FFFFFF]آلة حاسبة فائقة 
...
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            ...
                            menu9 = """[32CD32][B]═══⚡ اهم الادوات ⚡═══
[FFFFFF] رقصات اسلحه مطوره @evos
[FF0000] سبام رسائل /s1 iD
[FFFFFF] رقصه الضغط /e 12
[FF0000] رقصه الشيطان /e 20
[FFFFFF] 
[FF0000]If Any Problems, 
[C][B][FFB300]Contact Owner: [FFFFFF] Dm إذا كان هناك مشكله تواصل معي  [00FF00] @FENOTOP1  
[FFFFFF]━━━━━━━━━━━━"""
